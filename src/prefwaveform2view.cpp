...
PrefWaveform2View::PrefWaveform2View(QWidget *parent,int nbChannels,const char *name):
    PrefWaveform2ViewLayout(parent),nbChannels(nbChannels){
    if(nbChannels > 0) {
...
PrefWaveform2View::~PrefWaveform2View(){
}

void PrefWaveform2View::initializeChannelList(){
...
void PrefWaveform2View::resetChannelList(int nb){
    nbChannels = nb;
...
void PrefWaveform2View::saveChannelOrder(){
...
void PrefWaveform2View::loadChannelOrder(){
    QSettings settings;
...
void PrefWaveform2View::updateChannelPositions(){
    for(int i = 0; i< nbChannels; ++i){
